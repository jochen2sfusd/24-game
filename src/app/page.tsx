    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Collection of fun brain games</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <Link href="/games/24" className="group">
            <div className="bg-gray-100 rounded-2xl p-6 hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 border border-gray-200">
              <div className="text-center">
                <div className="text-4xl mb-4">🎯</div>
                <h2 className="text-2xl font-bold text-gray-800 mb-2">24 Game</h2>
